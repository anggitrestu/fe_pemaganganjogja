    ...
    <div className="pb-16 pt-16">
      <div className="">
        <Link href="https://peraturan.go.id/common/dokumen/bn/2020/bn351-2020.pdf">
          <a target="_blank" rel="noopener noreferrer" className="bg-[#FFE27A] flex-row bg-opacity-25 px-6 py-3 rounded-3xl text-yellow-300 font-normal mt-9 hover:bg-[#dfc462] hover:text-white transition-all text-sm lg:text-base">
            <span>
      ...
      <div className="flex flex-col w-full mt-9 ">
        ...
        <p className="text-[#C5C5C5] font-normal text-sm lg:text-base mt-9">
          Program pemagangan ini akan dimulai sejak 15 Maret 2022 hingga 15 Agustus
          2022, terbuka bagi seluruh <br /> perusahaan dan warga DIY yang
