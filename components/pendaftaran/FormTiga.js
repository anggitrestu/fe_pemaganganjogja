        ...
        <>
            ...
            <form className='mt-8'>
                <div className='mt-10 mb-6'>
                    <h4 className='text-[#404040] font-medium text-lg mb-6'>Informasi Pribadi</h4>
                    <input
                        type="text"
                        name="nama"
                    ...
                    <textarea placeholder='Tuliskan gambaran mengenai dirimu disini...' className="w-full border-[1px] bg-[#DFDFDF] cursor-pointer appearance-none text-base text-[#8F8F8F] focus:text-bermuda focus:outline-none focus:border-bermuda rounded-3xl py-8 px-8" rows="6"></textarea>
                </div>

                <div className='mt-10 mb-6'>
                    <h4 className='text-[#404040] font-medium text-lg mb-6'>Pendidikan Terakhir</h4>
                    <input
                        type="text"
                        name="namaSekolah"
                    ...
                    <select className="w-full border-[1px] bg-[#DFDFDF] cursor-pointer appearance-none text-base text-[#8F8F8F] focus:text-bermuda focus:outline-none focus:border-bermuda rounded-3xl py-5 px-8 mb-6">
                        <option hidden selected>Derajat Sekolah</option>
                        <option>Laki-Laki</option>
                        <option>Perempuan</option>
                    </select>
                    <input
                        ...
                        className='w-full border-[1px] bg-[#DFDFDF] cursor-pointer text-base text-[#8F8F8F] focus:text-bermuda focus:outline-none focus:border-bermuda rounded-3xl py-5 px-8 mb-6' />
                    <textarea placeholder='Diskripsikan pendidikan kamu disini...' className="w-full border-[1px] bg-[#DFDFDF] cursor-pointer appearance-none text-base text-[#8F8F8F] focus:text-bermuda focus:outline-none focus:border-bermuda rounded-3xl py-8 px-8 mb-6" rows="6"></textarea>
                    ...
                    <div className="form-check">
                        <input className="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-bermuda checked:border-bermuda focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" value="" id="flexCheckDefault" />
                        <label className="form-check-label inline-block text-[#404040] cursor-pointer" for="flexCheckDefault">
